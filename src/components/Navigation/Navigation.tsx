...
export const Navigation = () => {
  ...
  return (
    <div
      className={`w-[200px] h-inherit box-border bg-dark-container border-dark-tertiary border-r-[1px] px-5 py-20 md:relative top-0 absolute z-20 transition-all duration-500 ease-in-out ${
