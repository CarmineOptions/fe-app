...
const metamaskWallet: CustomWallet = {
  id: SupportedWalletIds.Metamask,
  name: "Metamask",
  alt: "Metamask",
  image:
  ...
  windowPropName: "starknet_metamask",
...
const customWalletIdMap: {
  ...
  [SupportedWalletIds.Metamask]: metamaskWallet,
};
